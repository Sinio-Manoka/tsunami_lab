...
tsunami_lab::patches::WavePropagation2d middle_states1(100, true);
...
// calculated bei geogebra
  tsunami_lab::patches::WavePropagation2d middle_states2(100, true);
...
// calculated bei geogebra
tsunami_lab::patches::WavePropagation2d middle_states3(100, false);
