...
As mentioned in the previous section, we add a variable ``k`` to create/readCheckpoint and to our ``fillConstants`` function.
...
**Better understanding of for loops**
    ...
    .. important::
        ...
        the third and fourth for loop are for the y and x value of the old grid that add the values of the old grid to the new grid and divide it by k*k to get the average value of the old grid value
