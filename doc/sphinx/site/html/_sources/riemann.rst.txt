...
Welcome to the documentation for our Riemann solver in C++. This solver is designed to help
you solve the Riemann problem for various hyperbolic partial differential equations.
This documentation will guide you through the functions we implemented to compile the Riemann
solver. The solver produces CSV files as output, which can be visualized through `ParaView <https://www.paraview.org/download>`_ .
